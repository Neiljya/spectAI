...
Works standalone or alongside val_api.py.
...
# ---------------------------------------------------------------------------
# Integration helper — use with val_api.py
# ---------------------------------------------------------------------------
...
def get_resolved_state():
    ...
    from val_api import ValorantLocalClient
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("val_api.py not found. Pass a JSON file as argument to test offline.")